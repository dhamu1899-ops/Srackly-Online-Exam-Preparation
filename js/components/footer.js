        ...
        <div class="text-left">
          ...
          <div class="pt-4 mt-4 border-t border-slate-800/80">
            ...
            <div class="flex items-center gap-2 flex-wrap">
              ...
              <!-- WhatsApp -->
              <a href="https://wa.me/919842712345" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Community" title="WhatsApp Community"
                class="w-8 h-8 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 flex items-center justify-center transition-all duration-200 shadow-sm hover:scale-110 hover:text-white">
              ...
              <!-- Telegram -->
              <a href="https://t.me/stacklysalem" target="_blank" rel="noopener noreferrer" aria-label="Telegram Group" title="Telegram Group"
                class="w-8 h-8 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 flex items-center justify-center transition-all duration-200 shadow-sm hover:scale-110 hover:text-white">
